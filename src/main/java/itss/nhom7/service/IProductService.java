...
public interface IProductService {
	...
	void addProduct(Product product, String category) throws SQLException, ParseException;			//them san pham vao kho (admin)
	MediaModel getMediaModelById(int id) throws SQLException;						//lay san pham theo id
	void editProduct(Product product, String category) throws SQLException, ParseException;			//thay doi thong tin san pham(admin)
